<template>
  <van-row>
    ...
    <van-row>
      <center><span @click="open_month_pick">报税税期</span></center>
    </van-row>
  ...
  <van-cell-group>
    <van-cell title="增值税" :value="accountTotal.shuijin" />
    <van-cell title="企业所得税" :value="accountTotal.qiyesuodeshui" />
    <van-cell title="个税" :value="accountTotal.gerensuodeshui" />
    <van-cell title="附加税" :value="accountTotal.qitashuifei" />
  </van-cell-group>
